...
{/*Fortnite*/}
 ...
 <div className="h-50 flex w-full items-center justify-center 
    bg-amber-300 rounded-lg hover:bg-red-400 transition transform hover:scale-103 
    duration-200 border-2 border-solid; bg-white border border-black-999 rounded-lg shadow-md">
   <div className="flex justify-center">
    <img 
    alt="Integral illustration"
  ...
  <div className="p-4">
   ...
   <div className="flex items-center mt-2">
    <span className="bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded border-2 border-balck-solid rounded-lg shadow-md">
     Calc 1 Topic
   ...
   <div className="flex items-center mt-2">
    <span className="bg-black-500 text-black text-xs font-semibold px-2 py-1 rounded rounded-lg hover:bg-amber-400 transition transform hover:scale-103 
